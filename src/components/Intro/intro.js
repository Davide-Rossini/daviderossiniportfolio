    ...
    return (
        <section id="intro">
            <div className="introContent">
                ...
                <p>I am a web developer and designer, proficient in creating visually appealing and functional websites with a strong foundation in coding and design principles.</p>
